...
> **📢 Modernized Fork:** This is an actively maintained fork of the official [platformio/platform-linux_arm](https://github.com/platformio/platform-linux_arm) platform (last updated May 2022). This fork adds **Raspberry Pi 5 support**, **modern lgpio framework**, **remote development workflows**, and **comprehensive examples**. See [CHANGELOG.md](CHANGELOG.md) for details.
...
- **Multiple GPIO frameworks**: lgpio (modern, Pi 5 compatible), pigpio, WiringPi
- **Comprehensive board support**: Raspberry Pi 1-5, Pi 400, CM4, Zero/Zero 2W, Orange Pi Zero
- **Architecture flexibility**: 32-bit (ARMv7) and 64-bit (AArch64) support
...
Advanced GPIO library with precise timing (Pi 1-4 only, NOT Pi 5).
...
Classic Arduino-like API with Pi 5 support (GCLK limitation on Pi 5).
